...
const Login = () => {
  const { backendUrl, token, setToken, userData } = useContext(AppContex);
        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-12 xl:p-16 flex flex-col justify-center relative z-10 bg-white/5 backdrop-blur-md">
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={password}
                  className="pl-10 pr-11 w-full p-3 rounded-xl border border-gray-700 bg-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200"
                  placeholder="••••••••"
                  required
                />
                <button
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-3.5 mt-4 rounded-xl font-bold text-white bg-gradient-to-r from-emerald-600 to-teal-500 shadow-md shadow-emerald-500/20 outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-300 flex items-center justify-center gap-2 ${loading ? 'opacity-80 cursor-not-allowed' : 'hover:from-emerald-500 hover:to-teal-400 hover:shadow-lg hover:shadow-emerald-500/30 hover:-translate-y-0.5 active:translate-y-0'}`}
            >
              {loading ? (
                <>
